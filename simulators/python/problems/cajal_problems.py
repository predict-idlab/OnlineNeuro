...
def create_stimulus(pos: list, stimulus_params, rhoe:float=500, **kwargs):

    point_sources = []
    for ix in range(0, len(pos), 3):
...
def ap_block(ap_monitor_stimulus, ap_monitor_block, start_time, end_time, verbose=False):
    """
...
def cajal_fun(
    ...
    stimulus = create_stimulus(pos=electrode_params['pos'],
